...
public class OffreEmploiTestSamples {
    ...
    public static OffreEmploi getOffreEmploiSample1() {
        return new OffreEmploi().id(1L).titre("titre1").description("description1").imagePath("imagePath1");
    }

    public static OffreEmploi getOffreEmploiSample2() {
        return new OffreEmploi().id(2L).titre("titre2").description("description2").imagePath("imagePath2");
    }
