...
public class RecruteurTestSamples {
    ...
    public static Recruteur getRecruteurSample1() {
        return new Recruteur().id(1L).entreprise("entreprise1").secteur("secteur1").logoPath("logoPath1");
    }

    public static Recruteur getRecruteurSample2() {
        return new Recruteur().id(2L).entreprise("entreprise2").secteur("secteur2").logoPath("logoPath2");
    }
